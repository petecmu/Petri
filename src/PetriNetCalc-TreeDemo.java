...
public class PetriNetCalc
{
    ...
    private static void getInit()
    {
        ...
        do
        {
        	...
        	//String input = JOptionPane.showInputDialog("Please enter the initial marking for your Net:  ");
            input = in.nextLine();
    ...
    private static void processTransOut()
    {
        for(int i=0; i < noTrans; i++)
        {
            ...
            do
            {
            	...
            	//String input = JOptionPane.showInputDialog("Please enter the outputs for Transition " + (i+1) +":  ");
                
            	// Read more: http://javarevisited.blogspot.com/2012/10/java-program-to-get-input-from-user.html#ixzz3tfA9GNIW
                //input = in.nextLine();
                if(verify(input, noPlaces))
                {
                    safeInput = true;
    ...
    private static void getNumPlaces()
    {
        do
        {
        	...
        	//String input = JOptionPane.showInputDialog("Please enter the number of Places in your net:  ");
            input = in.nextLine();
    ...
    private static void getNumTrans()
    {
        ...
        do
        {
        	...
        	//String input = JOptionPane.showInputDialog("Please enter the number of Transitions in your net:  ");
            input = in.nextLine();
            if(verify(input, POS_INT))
                safeInput = true;
            else
    ...
    private static void processTransIn()
    {
        for(int i=0; i < noTrans; i++)
        {
            ...
            do
            {
            	...
            	//String input = JOptionPane.showInputDialog("Please enter the inputs for Transition " + (i+1) +":  ");
                input = in.nextLine();
                if(verify(input, noPlaces))
                {
                    safeInput = true;
